...
<html lang="en">
  ...
  <head>
    ...
    <title>MeetJahit - Stakeholder</title>
      ...
      <div class="container">
        <div class="product-item">
          <div class="product-item-title d-flex">
            <div class="bg-faded p-5 d-flex ml-auto rounded">
              <h2 class="section-heading mb-0">
                <span class="section-heading-upper">Great</span>
                <span class="section-heading-lower">Tailors</span>
              </h2>
            </div>
          </div>
          <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="img/tailor.jpg" alt="">
          <div class="product-item-description d-flex mr-auto">
            <div class="bg-faded p-5 rounded">
              <p class="mb-0">Tailors can specialize in alterations or in sewing custom garments. Those who do alterations ensure that clothes fit customers properly. They make changes to garments, such as hemming pants to make them shorter or taking in seams to make clothing smaller.</p>
            </div>
          </div>
        </div>
      </div>
